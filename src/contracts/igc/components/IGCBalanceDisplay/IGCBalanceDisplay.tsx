...
import { useReadAssetFactoryBalanceOf, useWatchAssetFactoryIgCmintedEvent } from 'contracts/hooks'

import { IGCBalanceDisplayProps } from '../../types'
/**
 ...
 *
 * @param props - Props conforming to the {@link IGCBalanceDisplayProps} interface.
...
const IGCBalanceDisplay = ({
  ...
  return (
    <div className={className || 'around'}>
